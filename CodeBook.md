...
Extract the downloaded file in the working directory and replace filepath at the beginning with the path to downloaded folder.
Run the script
It should produce the text file
